...
leg_detector_msgs__msg__PersonArray__create()
{
  ...
  leg_detector_msgs__msg__PersonArray * msg = (leg_detector_msgs__msg__PersonArray *)allocator.allocate(sizeof(leg_detector_msgs__msg__PersonArray), allocator.state);
  if (!msg) {
    return NULL;
  }
...
leg_detector_msgs__msg__PersonArray__Sequence__init(leg_detector_msgs__msg__PersonArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (leg_detector_msgs__msg__PersonArray *)allocator.zero_allocate(size, sizeof(leg_detector_msgs__msg__PersonArray), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  leg_detector_msgs__msg__PersonArray__Sequence * array = (leg_detector_msgs__msg__PersonArray__Sequence *)allocator.allocate(sizeof(leg_detector_msgs__msg__PersonArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
