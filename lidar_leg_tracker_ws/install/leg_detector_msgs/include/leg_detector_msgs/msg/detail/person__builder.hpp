...
{
public:
  explicit Init_Person_velocity(::leg_detector_msgs::msg::Person & msg)
  : msg_(msg)
  {}
  Init_Person_id velocity(::leg_detector_msgs::msg::Person::_velocity_type arg)
  {
...
public:
  ...
  {}
  Init_Person_velocity pose(::leg_detector_msgs::msg::Person::_pose_type arg)
  {
