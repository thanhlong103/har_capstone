...
struct LegArray_
{
  ...
  _header_type header;
  using _legs_type =
    std::vector<leg_detector_msgs::msg::Leg_<ContainerAllocator>, typename ContainerAllocator::template rebind<leg_detector_msgs::msg::Leg_<ContainerAllocator>>::other>;
  _legs_type legs;
  ...
  Type & set__legs(
    const std::vector<leg_detector_msgs::msg::Leg_<ContainerAllocator>, typename ContainerAllocator::template rebind<leg_detector_msgs::msg::Leg_<ContainerAllocator>>::other> & _arg)
  {
    this->legs = _arg;
    return *this;
  }
