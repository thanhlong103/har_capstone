...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/install/leg_detector"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/leg_detector/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/leg_detector/environment/path.sh"
