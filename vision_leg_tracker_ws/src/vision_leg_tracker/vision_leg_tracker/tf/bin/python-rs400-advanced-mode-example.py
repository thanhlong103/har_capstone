...
try:
    ...
    while not advnc_mode.is_enabled():
        ...
        time.sleep(5)
        # The 'dev' object will become invalid and we need to initialize it
        # again
        dev = find_device_that_supports_advanced_mode()
        advnc_mode = rs.rs400_advanced_mode(dev)
        print(
    ...
    current_std_depth_control_group.scoreThreshA = int(
        (max_std_depth_control_group.scoreThreshA -
         min_std_depth_control_group.scoreThreshA) /
        2)
    ...
    # For Python 2, the values in 'as_json_object' dict need to be converted
    # from unicode object to utf-8
