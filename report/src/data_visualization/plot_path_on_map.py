...
# Load the map image
map_filename = "social_costmap_ws/src/turtlebot3/turtlebot3_navigation2/map/sim_map.pgm"  # Change to your map file path
yaml_filename = "social_costmap_ws/src/turtlebot3/turtlebot3_navigation2/map/sim_map.yaml"  # Change to your YAML file path
...
with open(odom_csv_filename, 'r') as csv_file:
    ...
    for row in csv_reader:
        x_vals.append(float(row[1]))  # x
        y_vals.append(float(row[2]))  # y
        theta_vals.append(float(row[3]))  # theta
